...
across education levels. From this distribution, we can see there is
large variability in age for both males and females across education
levels.
...
The plot below shows total activity (aggregated mims data) for each
participant by age with colors representing male and female and
