...
# 
The plot below shows total activity (aggregated mims data) for each participant by age with colors representing male and female and separated by education level

```{r plot_total_activity}
nhanes_df |> 
  group_by(seqn) |> 
  mutate(
